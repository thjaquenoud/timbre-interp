...
class Manne:
	...
	def define_net(self):
		...
		encoded1 = Conv1D(input_shape=(-1,decoder_outdim,1), filters=self.cnn_filters[0], kernel_size=3, kernel_regularizer=l2(l2_penalty))(encoded1)
		...
		decoded1 = Dense(units=decoder_outdim-4,
			activation=None,
			kernel_regularizer=l2(l2_penalty))(decoded1)
		decoded1 = LeakyReLU(alpha=alpha_val)(decoded1)
	...
	def train_net(self):
		...
		mlatent = Input(shape=(self.encoder_widths[-1],))
