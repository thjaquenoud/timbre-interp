...
class LoginScreen(BoxLayout):
    ...
    def gen_audio(self, seg_length, prog_ind):
        ...
        print(temp_negalpha.shape)
        print()
        print()
        print()
        print(temp_alpha.T.shape)
        temp_alpha=np.reshape(temp_alpha,(1,10))
        temp_negalpha=np.reshape(temp_negalpha,(1,10))
        print(temp_alpha.shape)
        print(temp_negalpha.shape)
