...
class LoginScreen(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.textinput1 = TextInput(text='o1.wav', size_hint_y=None, height=45, font_size=24)
        self.padAnchor3.add_widget(self.textinput1)
        self.add_widget(self.padAnchor3)

        self.padAnchor4 = AnchorLayout(size_hint_y=0.3)
        self.textinput2 = TextInput(text='o3.wav', size_hint_y=None, height=45, font_size=24)
    ...
    def gen_audio(self, seg_length, prog_ind):
        ...
        magA = magA.T
        print(magA.shape)
        magA = np.reshape(magA,(1,24,2049))
        ...
        magB = magB.T
        magB = np.reshape(magB,(1,24,2049))
        phaseB = np.angle(B) #Phase response of STFT

        print(self.temp_sliders.shape)
        print(self.alpha.shape)

        temp_alpha = self.alpha*self.temp_sliders      		# NUM_CHUNKS+5 is really sus, might have
        temp_negalpha = (1-self.alpha)*self.temp_sliders    #
        ...
        temp_out_mag = np.reshape(temp_out_mag,(24,2049))
